                ...
                public void onSuccess(Location location) {
                    ...
                    if (location != null) {
                        ...
                        for(Event event : events){
                            ...
                            try{
                                latEvent = Double.parseDouble(splitLocation[0]);
                                longiEvent = Double.parseDouble(splitLocation[1]);

                                HttpURLConnectionAsyncTask httpURLConnectionAsyncTask = new HttpURLConnectionAsyncTask();
                                String url = "https://maps.googleapis.com/maps/api/distancematrix/json?origins="+ lat + "," + lng + "&destinations=" + latEvent+","
                                        + longiEvent + "&key=AIzaSyBv8SDb_qSJAaQKrkMkugurszYqCLEHuvg";
